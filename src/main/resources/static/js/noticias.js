let todasNoticias = [];
    ...
    document.addEventListener("DOMContentLoaded", () => {
      ...
      document.getElementById('formNuevaNoticia').addEventListener('submit', function(e) {
        ...
        const noticia = {
          ...
          sistema: document.getElementById('sistemaNoticia').value,
          fechaPublicacion: document.getElementById('fechaNoticia').value,
    ...
    function aplicarFiltros() {
      ...
      if (sistema) {
        filtradas = filtradas.filter(n => n.sistema === sistema);
      }
      if (titulo) {
